...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($numero === "" || filter_var($numero, FILTER_VALIDATE_INT) === false || $numero < 0) {
    $erros[] = "Por favor, insira um número inteiro positivo (sem vírgulas ou decimais).";
    } else {
        $numero = (int)$numero; 
        ...
        $resultado = "A soma dos números de 1 a $numero é $soma";
...
<head>
    <meta charset="UTF-8">
    <title>Ex. 11: Somatório com for</title>
    <style>
        body {
